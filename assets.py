...
info_message = "A bot that plays **elevator music** for hours and hours.\n" \
               ...
               "</elevatorinfo:%s>     `Shows this info.`\n" \
               "</elevatormusic:%s>     `Starts playing elevator music in your channel.`\n" \
               "</fahrstuhlmusik:%s>     `Also starts playing elevator music in your channel. :)`\n" \
               "</elevatorreview:%s>     `You can rate and review the bot on different sites.`\n" \
               "</elevatorshutdown:%s>     `The bot leaves the current channel.`\n\n" \
